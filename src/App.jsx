...
import {
  MapPin, Clock, Phone, MessageCircle, ChevronDown, Star,
  Shield, Users, Zap, CheckCircle, Instagram, Globe,
  ArrowRight, Menu, X, Calendar, Navigation, Wifi, Award
} from 'lucide-react'
  ...
  return (
    <div className="flex items-center gap-3">
      <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Road swoosh left */}
        <path d="M12 72 Q28 45 50 50 Q28 50 18 68 Z" fill="#e31e24" opacity="0.9"/>
        {/* Road swoosh right */}
        <path d="M88 72 Q72 45 50 50 Q72 50 82 68 Z" fill="#e31e24" opacity="0.9"/>
        {/* Center road line dashes */}
        <path d="M50 50 L50 70" stroke="white" strokeWidth="1.5" strokeDasharray="3 3"/>
        {/* Big M letter */}
        <text x="50" y="56" fontFamily="Arial Black, sans-serif" fontSize="40" fontWeight="900"
              fill={dark ? '#1a1a1a' : '#ffffff'} textAnchor="middle" dominantBaseline="middle">M</text>
        {/* Speed lines top */}
      ...
      {showText && (
        <div className="leading-none">
          <div className={`font-display text-2xl tracking-wide leading-none ${dark ? 'text-brand-black' : 'text-white'}`}>
            MÉNDEZ
          </div>
          <div className={`text-xs font-semibold tracking-widest uppercase ${dark ? 'text-brand-red' : 'text-brand-red'}`}>
            TRANSPORT
          </div>
        </div>
      )}
...
function WhatsAppQR({ url, size = 200, label = "" }) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="qr-glow rounded-2xl p-3 bg-white">
        <QRCodeSVG
          value={url}
          size={size}
          bgColor="#ffffff"
      ...
      {label && (
        <p className="text-sm font-semibold text-gray-400 text-center">{label}</p>
      )}
    </div>
  )
}
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-14">
          <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Why Choose Us</span>
          <h2 className="font-display text-5xl text-brand-black mt-2">
            TRAVEL THE WAY YOU DESERVE
          </h2>
          <p className="text-gray-500 mt-3 max-w-xl mx-auto">
            Méndez Transport delivers premium shuttle experiences across Panama's most beautiful destinations.
          </p>
        </FadeIn>
          ...
          {benefits.map((b, i) => (
            <FadeIn key={b.title} delay={i * 0.12} direction="up">
              <div className="card-hover group bg-white rounded-2xl p-7 border border-gray-100 shadow-sm hover:shadow-xl hover:border-brand-red/20 text-center">
                <div className={`w-16 h-16 mx-auto mb-5 rounded-2xl bg-gradient-to-br ${b.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  {b.icon}
                </div>
                <h3 className="font-bold text-brand-black text-lg mb-2">{b.title}</h3>
...
function FeaturedDestinations() {
  ...
  return (
    <section id="destinations" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-14">
          <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Where We Go</span>
          <h2 className="font-display text-5xl text-brand-black mt-2">FEATURED DESTINATIONS</h2>
          <p className="text-gray-500 mt-3 max-w-xl mx-auto">
            Hand-picked destinations for the ultimate Panama experience.
          </p>
        </FadeIn>
            ...
            <FadeIn key={dest.name} delay={i * 0.15}>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 z-10 p-7">
                  ...
                  <p className="text-gray-200 text-sm mb-5">{dest.tagline}</p>
  ...
  return (
    <section id="prices" className="py-20 gradient-dark">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-14">
          <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Transparent Pricing</span>
          <h2 className="font-display text-5xl text-white mt-2">DESTINATIONS & PRICES</h2>
          ...
          <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
            ...
            <div className="bg-brand-red px-8 py-5 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold uppercase tracking-widest text-sm">Destination</span>
              </div>
              <span className="text-white font-bold uppercase tracking-widest text-sm">Price / Person</span>
            </div>
            ...
            <div className="bg-brand-black divide-y divide-white/5">
              {destinations.map((d, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-white font-black text-2xl">${d.price}</span>
            ...
            <div className="bg-white/5 px-8 py-4 flex items-center gap-3">
              ...
              <span className="text-gray-400 text-sm">
                All routes depart daily at <strong className="text-white">7:40 AM</strong> · Private transport available upon request
              </span>
            </div>
          </div>
        </FadeIn>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn direction="left">
            <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Our Vehicle</span>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed text-lg">
              Our Toyota HiAce "Turismo" minibus is equipped for the road and ready for tourists.
              Spacious, air-conditioned and maintained to the highest standard — your journey is in safe hands.
            </p>
            ...
            <div className="relative">
              ...
              <div className="mt-4 rounded-2xl overflow-hidden shadow-xl relative">
                ...
                <div className="absolute left-5 top-1/2 -translate-y-1/2">
                  <p className="text-white font-bold text-lg">Spacious Interior</p>
                  <p className="text-gray-300 text-sm">Comfortable seating for every journey</p>
                </div>
              </div>
              ...
              >
                ...
                <div className="text-xs font-semibold uppercase tracking-widest opacity-90">Daily AM</div>
              </motion.div>
            </div>
          </FadeIn>
        </div>
          ...
          <FadeIn direction="left" className="lg:col-span-2">
            <div className="glass rounded-3xl p-10">
              <h2 className="font-display text-6xl text-white mb-4 leading-none">
                YOUR PANAMA<br />
                <span className="text-brand-red">ADVENTURE</span><br />
                STARTS HERE
              </h2>
              <p className="text-gray-300 text-lg mb-8 max-w-lg">
                From the lush highlands of Boquete to the crystal lagoons of Bocas del Toro —
                Méndez Transport takes you there in comfort and style.
              </p>
...
function BusinessCardSection() {
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-14">
          <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Always With You</span>
          <h2 className="font-display text-5xl text-brand-black mt-2">SAVE OUR CONTACT</h2>
          <p className="text-gray-500 mt-3 max-w-xl mx-auto">
            Scan the QR code to open WhatsApp instantly or save our info for your trip.
          </p>
        </FadeIn>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          <FadeIn direction="right">
            <div className="bg-brand-black rounded-3xl p-8 text-center">
              <MendezLogo size={48} showText={true} dark={false} />
              ...
              <div className="mt-8 space-y-3">
                ...
                >
                  <WhatsAppIcon size={20} />
                  <span className="text-white font-semibold">+507 6925-5088</span>
                </a>
                <a
                  href="https://wa.me/50768768467"
                  target="_blank"
                ...
                >
                  <WhatsAppIcon size={20} />
                  <span className="text-white font-semibold">+507 6876-8467</span>
                </a>
              </div>
  ...
  return (
    <section id="contact" className="py-20 bg-brand-black relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <FadeIn>
          <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Get In Touch</span>
          <h2 className="font-display text-6xl text-white mt-2 mb-4">
            RESERVE YOUR<br />
            <span className="text-brand-red">SEAT TODAY</span>
          </h2>
          <p className="text-gray-400 text-xl mb-12 max-w-2xl mx-auto">
            Don't miss your departure. Contact us on WhatsApp right now and confirm your spot for tomorrow's 7:40 AM shuttle.
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.2} className="flex justify-center mb-12">
          <div className="relative">
            ...
            <WhatsAppQR url="https://wa.me/50769255088" size={220} label="Scan · Tap · Book" />
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.4}>
          <div className="flex items-center justify-center gap-6 text-gray-500">
            ...
            <span>·</span>
            <a href="#" className="flex items-center gap-2 hover:text-blue-400 transition-colors font-medium">
              <Globe size={20} />
              Website
            </a>
            <span>·</span>
            <a href="#" className="flex items-center gap-2 hover:text-brand-red transition-colors font-medium">
              <Phone size={20} />
              Call Us
            </a>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center text-gray-500 text-sm">
            <p className="font-semibold text-gray-300 mb-1">Shared or Private Transportation</p>
          ...
          <div className="flex items-center gap-4 text-gray-600 text-sm">
            ...
            <a href="https://wa.me/50769255088" target="_blank" rel="noopener noreferrer"
               className="hover:text-[#25D366] transition-colors">
              <MessageCircle size={18} />
            </a>
            <a href="https://wa.me/50768768467" target="_blank" rel="noopener noreferrer"
               className="hover:text-[#25D366] transition-colors">
              <Phone size={18} />
            </a>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/5 text-center text-gray-700 text-xs">
          © {new Date().getFullYear()} Méndez Transport · Panama · All rights reserved
        </div>
      </div>
    </footer>
  )
