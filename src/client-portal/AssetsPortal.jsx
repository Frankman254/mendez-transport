    ...
    assets: [
      {
        ...
        file: '/shared/logos/logo-grande.png',
        thumb: '/shared/logos/logo-grande.png',
        thumbBg: 'bg-gray-800',
      ...
      },
      {
        ...
        file: '/shared/logos/logo-transparente.png',
        thumb: '/shared/logos/logo-transparente.png',
        thumbBg: 'bg-gray-700',
        whiteBackground: false,
      },
      {
        ...
        file: '/shared/logos/logo-vectorizado.svg',
        thumb: '/shared/logos/logo-vectorizado.svg',
        thumbBg: 'bg-gray-800',
        whiteBackground: false,
      },
      {
        ...
        file: '/shared/logos/logobus-fondo-blanco.png',
        thumb: '/shared/logos/logobus-fondo-blanco.png',
        thumbBg: 'bg-white',
      ...
      },
      {
        ...
        file: '/shared/logos/logo-fondo-blanco.png',
        thumb: '/shared/logos/logo-fondo-blanco.png',
        thumbBg: 'bg-white',
        whiteBackground: true,
      },
      {
        ...
        file: '/shared/logos/logo-fondo-blanco3.png',
        thumb: '/shared/logos/logo-fondo-blanco3.png',
        thumbBg: 'bg-white',
        whiteBackground: true,
      },
      {
        ...
        file: '/shared/logos/logomascota-fondo-blanco.png',
        thumb: '/shared/logos/logomascota-fondo-blanco.png',
        thumbBg: 'bg-white',
        whiteBackground: true,
      },
      {
        ...
        file: '/shared/logos/logomascota-fondo-blanco2.png',
        thumb: '/shared/logos/logomascota-fondo-blanco2.png',
        thumbBg: 'bg-white',
        whiteBackground: true,
      },
      {
        ...
        file: '/tourism/brand/mascotas.png',
        thumb: '/tourism/brand/mascotas.png',
        thumbBg: 'bg-gray-800',
        whiteBackground: false,
      },
    ],
...
function WebViewButton() {
  ...
  const handleSubmit = (e) => {
    ...
    if (pwd === 'mendez7904') {
      ...
      window.location.href = '/portal-cliente/vista-pagada';
    } else {
      setError(true);
